...
'''scale input image into specified size,first fit shoter side,if exceed the MAX_SIZE,then fit the longer side.
And should make sure the sides are mutiples of a specified number,thus would not meet error in full connnect layer'''
def _get_image_blob(im):
    ...
    """
    cfg.TEST.SCALE_MULTIPLE_OF =32 #add by wz
    ...
    for target_size in cfg.TEST.SCALES:#(640,)
